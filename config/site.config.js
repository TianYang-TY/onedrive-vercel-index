...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || "tianyang_ty@outlook.com",
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/TianYang-TY/onedrive-vercel-index',
    },
  ],
